                        ...
                        <div class="col-lg-6 col-md-3 col-6">
                            <div class="card text-center">
                                <div class="card-body">
                                    ...
                                    <h2 class="fw-bolder">{{ $jenisIkan }}</h2>
                                    <p class="card-text">Jenis Ikan</p>
                                </div>
                            </div>
                        </div>
                        <!--/ Bar Chart - Orders -->
                        ...
                        <div class="col-lg-6 col-md-3 col-6 ">
                            <div class="card text-center">
                                <div class="card-body">
                                    ...
                                    <h2 class="fw-bolder">{{ $kurir }}</h2>
                                    <p class="card-text">Kurir</p>
                                </div>
                            </div>
                        </div>
                        <!--/ Line Chart - Profit -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-sm-0">
                                    <div class="d-flex flex-row">
                                        ...
                                        <div class="my-auto">
                                            <h4 class="fw-bolder mb-0">{{ $userNelayan }}</h4>
                                            <p class="card-text font-small-3 mb-0">Nelayan</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-5 col-sm-7 col-12">
                                    <div class="d-flex flex-row">
                                        ...
                                        <div class="my-auto">
                                            <h4 class="fw-bolder mb-0">{{ $userCostumer }}</h4>
                                            <p class="card-text font-small-3 mb-0">Costumer</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
